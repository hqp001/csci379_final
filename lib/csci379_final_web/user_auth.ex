defmodule Csci379FinalWeb.UserAuth do
  ...
  alias Csci379Final.Accounts.Scope

  def on_mount(:require_authenticated_user, _params, session, socket) do
    socket = mount_current_scope(socket, session)
    socket = mount_locale(socket, session)
  ...
  defp mount_locale(socket, session) do
  ...
  @remember_me_cookie "_csci379_final_web_user_remember_me"
  @remember_me_options [
    sign: true,
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      Csci379FinalWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end

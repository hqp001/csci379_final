...
config :csci379_final, Csci379FinalWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "9eixqjHIZjQwTU/89mfV/70r3XhIN9KuWOJrmrxFJ0zkQOJwGsLkrzrGQWaNKtGF",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:csci379_final, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:csci379_final, ~w(--watch)]}
  ]
...
config :ueberauth, Ueberauth,
  providers: [
    google: {Ueberauth.Strategy.Google, [default_scope: "email profile", callback_url: "http://localhost:4000/auth/google/callback"]}
  ]
